...
function fwd_scripts() {
	...
	if ( is_front_page() ) {
		wp_enqueue_style( 'swiper-styles', get_template_directory_uri() .'/css/swiper-bundle.css', array(), '11.1.3' );
		wp_enqueue_script( 'swiper-scripts', get_template_directory_uri() .'/js/swiper-bundle.min.js', array(), '11.1.3', array( 'strategy' => 'defer' )  );
...
//change the exverpt more text
function fwd_excerpt_more( $more ) {
    $more = '... <a class="read-more" href="' . esc_url( get_permalink() ) . '">'. __('Continue Reading').'</a>';
    return $more;
}
